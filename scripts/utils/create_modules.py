#!/usr/bin/env python
"""Create initial modules and pricing for the application."""
import os
import django
...
for data in modules_data:
    ...
    print(f"{'Created' if created else 'Updated'}: {module.name}")
...
print('\nAll modules created with pricing!')
print(f'Total modules: {Module.objects.count()}')
print(f'Total pricing options: {ModulePricing.objects.count()}')
