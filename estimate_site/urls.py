...
urlpatterns = [
    ...
    path('saved-works/<int:work_id>/rename/', saved_works_views.rename_saved_work, name='rename_saved_work'),
    path('saved-works/<int:work_id>/workflow-data/', saved_works_views.get_workflow_data, name='get_workflow_data'),
    path('saved-works/<int:work_id>/workslip-choice/', saved_works_views.workslip_choice, name='workslip_choice'),
    path('saved-works/<int:work_id>/bill-type-choice/', saved_works_views.bill_type_choice, name='bill_type_choice'),
    path('saved-works/<int:work_id>/generate-bill-with-type/', saved_works_views.generate_bill_with_type, name='generate_bill_with_type'),
