...
urlpatterns = [
    ...
    path('api/announcements/<int:announcement_id>/dismiss/', dashboard_views.api_dismiss_announcement, name='api_dismiss_announcement'),
    ...
    path('saved-works/<int:work_id>/status/', saved_works_views.save_work_status, name='save_work_status'),
    path('saved-works/<int:work_id>/status/get/', saved_works_views.get_work_status, name='get_work_status'),
    path('saved-works/progress-report/', saved_works_views.progress_report, name='progress_report'),
    ...
    path(
        "tempdatas/<str:category>/ajax_save_group_order/",
        views.temp_ajax_save_group_order,
        name="temp_ajax_save_group_order",
    ),
    path(
    ...
    path(
        "amc/<str:category>/ajax_save_group_order/",
        views.amc_ajax_save_group_order,
        name="amc_ajax_save_group_order",
    ),
