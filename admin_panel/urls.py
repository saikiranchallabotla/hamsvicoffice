...
urlpatterns = [
    ...
    path('data/area-allowance/', data_management_views.area_allowance, name='admin_area_allowance'),
    path('data/area-allowance/download/', data_management_views.download_area_allowance, name='admin_download_area_allowance'),
